...
public class SelectCategoryFragment extends Fragment
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable final Bundle savedInstanceState) {
        ...
        binding = ActivitySelectCategoryBinding.inflate(inflater, container, false);
...
//                    binding.categoriesRecyclerView.getLayoutManager().onRestoreInstanceState(savedInstanceState.getParcelable(CATEGORIES_LAYOUT_MANAGER));
                }
            }, 300);
...
//        outState.putParcelable(CATEGORIES_LAYOUT_MANAGER, binding.categoriesRecyclerView.getLayoutManager().onSaveInstanceState());
...
//        binding.categoriesRecyclerView.scheduleLayoutAnimation();
    }
    ...
    private void initUi(){
        ...
        if(mainActivity.getSharedPref().loadNightModeState()) {
            if (hasInternet) {
                binding.selectCategoryLabel.setText(Html.fromHtml(mainActivity.getResources().getString(R.string.select_category_label_dark)));
            } else {
                binding.selectCategoryLabel.setText(Html.fromHtml(mainActivity.getResources().getString(R.string.no_internet_label_dark)));
            }
        } else {
            if (hasInternet) {
                binding.selectCategoryLabel.setText(Html.fromHtml(mainActivity.getResources().getString(R.string.select_category_label)));
            } else {
                binding.selectCategoryLabel.setText(Html.fromHtml(mainActivity.getResources().getString(R.string.no_internet_label)));
            }
        }
    }
